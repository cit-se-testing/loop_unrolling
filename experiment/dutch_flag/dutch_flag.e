...
--			blue_first: across 1 |..| (Result.b - 1) as ai all a.sequence [ai] = 1 end
--			white_second: across Result.b |..| Result.r as ai all a.sequence [ai] = 2 end
--			red_last: across (Result.r + 1) |..| a.count as ai all a.sequence [ai] = 3 end
